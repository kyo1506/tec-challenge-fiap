...
public class TransactionServiceTest
{
    ...
    public async Task ProcessPurchase_Success()
    {
        ...
        _promotionRepositoryMock
            .Setup(x => x.GetPromotionGameById(promotionGameId))
            .ReturnsAsync(promotionGame);

        var result = await _transactionService.ProcessPurchaseAsync(
            userId,
            game.Id,
            promotionGameId
        );
    ...
    public async Task ProcessPurchase_InsufficientBalanceException()
    {
        ...
        _promotionRepositoryMock
            .Setup(x => x.GetPromotionGameById(It.IsAny<Guid>()))
    ...
    public async Task ProcessPurchase_LibraryNotFoundException()
    {
        ...
        _gameRepositoryMock
            .Setup(x => x.FirstOrDefaultAsync(It.IsAny<Expression<Func<Game, bool>>>(), true, null))
            .ReturnsAsync(
                new Game
                {
                    Name = "Test Game",
    ...
    public async Task ProcessPurchaseAsync_Should_Throw_DomainException_When_Game_Already_In_Library()
    {
        ...
        {
            UserId = userId,
            Items = new List<LibraryItem> { new LibraryItem { GameId = gameId } },
        };
